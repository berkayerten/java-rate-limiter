...
class RateLimiterSlidingWindowTest {

    @Test
    void shouldAllowRequestsWithinSlidingTime() {
        RateLimiter rateLimiter = new RateLimiter(new SlidingWindowStrategy(2, 1_000));
    ...
    void shouldNotAllowRequestsBeyondFixedTimeWindow() throws InterruptedException {
        // given
        RateLimiter rateLimiter = new RateLimiter(new SlidingWindowStrategy(2, 5_000));
